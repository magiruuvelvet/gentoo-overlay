...
QTC_PLUGINS=(android +autotest baremetal beautifier boot2qt -marketplace -emacskeys -updateinfo -cpaster
	clearcase -autotools:autotoolsprojectmanager -meson:mesonprojectmanager
	cmake:cmakeprojectmanager cppcheck ctfvisualizer -cvs +designer -git -bazaar glsl:glsleditor +help ios
	...
	silversearcher -subversion valgrind webassembly winrt -vcsbase -todo -tasklist -fakevim -conan)
...
src_configure() {
	eqmake5 IDE_LIBRARY_BASENAME="$(get_libdir)" \
		...
		LLVM_INSTALL_DIR="/usr/lib/llvm/11" \
