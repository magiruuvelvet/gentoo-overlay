...
src_install() {
    ...
    # install missing linux-headers symlinks
    ln -s /usr/include/asm "${D}/usr/musl/include/asm"
    ln -s /usr/include/asm-generic "${D}/usr/musl/include/asm-generic"
    ln -s /usr/include/mtd "${D}/usr/musl/include/mtd"
}
